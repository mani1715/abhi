...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const allNavItems = [
    ...
    { path: '/admin/feelings-services', icon: Heart, label: 'Feelings Services', permission: 'canManageFeelingsServices' },
    { path: '/admin/service-requests', icon: MessageSquare, label: 'Service Requests', permission: 'canManageServiceRequests' },
    { path: '/admin/generated-links', icon: Link2, label: 'Generated Links', permission: 'canManageGeneratedLinks' },
