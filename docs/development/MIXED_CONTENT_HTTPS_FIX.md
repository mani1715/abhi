...
- **Page URL**: `https://moodcraft-21.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://moodcraft-21.preview.emergentagent.com`
- API calls go to: `https://moodcraft-21.preview.emergentagent.com/api`
