...
- **Page URL**: `https://portfolioabhi.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://portfolioabhi.preview.emergentagent.com`
- API calls go to: `https://portfolioabhi.preview.emergentagent.com/api`
