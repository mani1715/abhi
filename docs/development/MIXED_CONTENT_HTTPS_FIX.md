...
- **Page URL**: `https://codebase-builder-2.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://codebase-builder-2.preview.emergentagent.com`
- API calls go to: `https://codebase-builder-2.preview.emergentagent.com/api`
