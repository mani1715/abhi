...
- **Page URL**: `https://magical-brahmagupta-1.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://magical-brahmagupta-1.preview.emergentagent.com`
- API calls go to: `https://magical-brahmagupta-1.preview.emergentagent.com/api`
