...
- **Page URL**: `https://project-abhi.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://project-abhi.preview.emergentagent.com`
- API calls go to: `https://project-abhi.preview.emergentagent.com/api`
