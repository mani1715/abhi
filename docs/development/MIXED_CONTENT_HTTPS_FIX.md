...
- **Page URL**: `https://digital-canvas-94.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://digital-canvas-94.preview.emergentagent.com`
- API calls go to: `https://digital-canvas-94.preview.emergentagent.com/api`
