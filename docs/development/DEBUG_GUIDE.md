...
### Chrome/Edge:
1. Open the page: `https://forge-studio-6.preview.emergentagent.com`
...
1. Open the admin panel: `https://forge-studio-6.preview.emergentagent.com/admin/login`
...
fetch('https://forge-studio-6.preview.emergentagent.com/api/')
  .then(r => r.json())
...
fetch(`https://forge-studio-6.preview.emergentagent.com/api/admin/client-projects/${PROJECT_ID}/tasks`, {
  method: 'POST',
  headers: {
...
4. Reopen browser
5. Go to: `https://forge-studio-6.preview.emergentagent.com/admin/login`
6. Try again
...
2. Go to: `https://forge-studio-6.preview.emergentagent.com/admin/login`
3. Login
4. Try adding a task
...
Should include: `https://forge-studio-6.preview.emergentagent.com`
