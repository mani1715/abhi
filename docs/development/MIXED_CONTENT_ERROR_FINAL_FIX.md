...
```
Mixed Content: The page at 'https://digital-canvas-94.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://digital-canvas-94.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://digital-canvas-94.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://digital-canvas-94.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://digital-canvas-94.preview.emergentagent.com/api/client/projects \
