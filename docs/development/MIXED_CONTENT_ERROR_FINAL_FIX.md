...
```
Mixed Content: The page at 'https://content-studio-130.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://content-studio-130.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://content-studio-130.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://content-studio-130.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://content-studio-130.preview.emergentagent.com/api/client/projects \
