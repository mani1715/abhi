...
```
Mixed Content: The page at 'https://moodcraft-21.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://moodcraft-21.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://moodcraft-21.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://moodcraft-21.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://moodcraft-21.preview.emergentagent.com/api/client/projects \
