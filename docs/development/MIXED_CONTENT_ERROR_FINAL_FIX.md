...
```
Mixed Content: The page at 'https://project-abhi.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://project-abhi.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://project-abhi.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://project-abhi.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://project-abhi.preview.emergentagent.com/api/client/projects \
