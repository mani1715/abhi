...
```
Mixed Content: The page at 'https://forge-studio-6.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://forge-studio-6.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://forge-studio-6.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://forge-studio-6.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://forge-studio-6.preview.emergentagent.com/api/client/projects \
