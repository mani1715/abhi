...
```
Mixed Content: The page at 'https://abhi-personal.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://abhi-personal.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://abhi-personal.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://abhi-personal.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://abhi-personal.preview.emergentagent.com/api/client/projects \
