...
```
Mixed Content: The page at 'https://side-service.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://side-service.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://side-service.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://side-service.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://side-service.preview.emergentagent.com/api/client/projects \
