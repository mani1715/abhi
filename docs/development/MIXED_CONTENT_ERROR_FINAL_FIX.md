...
```
Mixed Content: The page at 'https://text-alchemy.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://text-alchemy.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://text-alchemy.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://text-alchemy.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://text-alchemy.preview.emergentagent.com/api/client/projects \
