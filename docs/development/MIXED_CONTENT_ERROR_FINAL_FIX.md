...
```
Mixed Content: The page at 'https://compact-services-1.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://compact-services-1.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://compact-services-1.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://compact-services-1.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://compact-services-1.preview.emergentagent.com/api/client/projects \
