...
```
Mixed Content: The page at 'https://source-deploy.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://source-deploy.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://source-deploy.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://source-deploy.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://source-deploy.preview.emergentagent.com/api/client/projects \
