...
```
Mixed Content: The page at 'https://portfolioabhi.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://portfolioabhi.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://portfolioabhi.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://portfolioabhi.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://portfolioabhi.preview.emergentagent.com/api/client/projects \
