...
# CORS Configuration
CORS_ORIGINS=http://localhost:3000,https://magical-brahmagupta-1.preview.emergentagent.com
...
- `https://magical-brahmagupta-1.preview.emergentagent.com` - for production
