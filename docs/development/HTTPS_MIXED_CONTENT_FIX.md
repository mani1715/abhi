...
### Error Message
```
Mixed Content: The page at 'https://abhi-service-hub.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://abhi-service-hub.preview.emergentagent.com`): Uses `/api` → converted to `https://abhi-service-hub.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://abhi-service-hub.preview.emergentagent.com,https://abhi-service-hub.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://abhi-service-hub.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://abhi-service-hub.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://abhi-service-hub.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://abhi-service-hub.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://abhi-service-hub.preview.emergentagent.com`
