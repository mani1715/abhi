...
### Error Message
```
Mixed Content: The page at 'https://source-deploy.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://source-deploy.preview.emergentagent.com`): Uses `/api` → converted to `https://source-deploy.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://source-deploy.preview.emergentagent.com,https://source-deploy.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://source-deploy.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://source-deploy.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://source-deploy.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://source-deploy.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://source-deploy.preview.emergentagent.com`
