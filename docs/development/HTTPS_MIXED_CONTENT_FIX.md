...
### Error Message
```
Mixed Content: The page at 'https://side-service.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://side-service.preview.emergentagent.com`): Uses `/api` → converted to `https://side-service.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://side-service.preview.emergentagent.com,https://side-service.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://side-service.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://side-service.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://side-service.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://side-service.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://side-service.preview.emergentagent.com`
