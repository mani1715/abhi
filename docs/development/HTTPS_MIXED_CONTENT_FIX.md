...
### Error Message
```
Mixed Content: The page at 'https://project-abhi.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://project-abhi.preview.emergentagent.com`): Uses `/api` → converted to `https://project-abhi.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://project-abhi.preview.emergentagent.com,https://project-abhi.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://project-abhi.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://project-abhi.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://project-abhi.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://project-abhi.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://project-abhi.preview.emergentagent.com`
