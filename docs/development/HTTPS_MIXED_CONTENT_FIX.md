...
### Error Message
```
Mixed Content: The page at 'https://text-alchemy.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://text-alchemy.preview.emergentagent.com`): Uses `/api` → converted to `https://text-alchemy.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://text-alchemy.preview.emergentagent.com,https://text-alchemy.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://text-alchemy.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://text-alchemy.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://text-alchemy.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://text-alchemy.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://text-alchemy.preview.emergentagent.com`
