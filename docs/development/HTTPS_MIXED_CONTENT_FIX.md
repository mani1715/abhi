...
### Error Message
```
Mixed Content: The page at 'https://portfolioabhi.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://portfolioabhi.preview.emergentagent.com`): Uses `/api` → converted to `https://portfolioabhi.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://portfolioabhi.preview.emergentagent.com,https://portfolioabhi.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://portfolioabhi.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://portfolioabhi.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://portfolioabhi.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://portfolioabhi.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://portfolioabhi.preview.emergentagent.com`
