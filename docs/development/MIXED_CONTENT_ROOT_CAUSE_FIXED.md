...
# CORS Configuration  
CORS_ORIGINS=https://prompt-craft-188.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://prompt-craft-188.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://prompt-craft-188.preview.emergentagent.com/api/client/projects`
...
When you access: `https://prompt-craft-188.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://prompt-craft-188.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://prompt-craft-188.preview.emergentagent.com` (production)
