...
# CORS Configuration  
CORS_ORIGINS=https://side-service.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://side-service.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://side-service.preview.emergentagent.com/api/client/projects`
...
When you access: `https://side-service.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://side-service.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://side-service.preview.emergentagent.com` (production)
