...
# CORS Configuration  
CORS_ORIGINS=https://source-deploy.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://source-deploy.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://source-deploy.preview.emergentagent.com/api/client/projects`
...
When you access: `https://source-deploy.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://source-deploy.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://source-deploy.preview.emergentagent.com` (production)
