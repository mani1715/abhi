...
# CORS Configuration  
CORS_ORIGINS=https://abhi-personal.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://abhi-personal.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://abhi-personal.preview.emergentagent.com/api/client/projects`
...
When you access: `https://abhi-personal.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://abhi-personal.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://abhi-personal.preview.emergentagent.com` (production)
