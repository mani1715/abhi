...
# CORS Configuration  
CORS_ORIGINS=https://dev-abhi.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://dev-abhi.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://dev-abhi.preview.emergentagent.com/api/client/projects`
...
When you access: `https://dev-abhi.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://dev-abhi.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://dev-abhi.preview.emergentagent.com` (production)
