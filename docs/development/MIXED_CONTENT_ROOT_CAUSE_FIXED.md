...
# CORS Configuration  
CORS_ORIGINS=https://magical-brahmagupta-1.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://magical-brahmagupta-1.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://magical-brahmagupta-1.preview.emergentagent.com/api/client/projects`
...
When you access: `https://magical-brahmagupta-1.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://magical-brahmagupta-1.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://magical-brahmagupta-1.preview.emergentagent.com` (production)
