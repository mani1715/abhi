...
# CORS Configuration  
CORS_ORIGINS=https://portfolioabhi.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://portfolioabhi.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://portfolioabhi.preview.emergentagent.com/api/client/projects`
...
When you access: `https://portfolioabhi.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://portfolioabhi.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://portfolioabhi.preview.emergentagent.com` (production)
