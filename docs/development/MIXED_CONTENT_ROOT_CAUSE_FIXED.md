...
# CORS Configuration  
CORS_ORIGINS=https://text-alchemy.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://text-alchemy.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://text-alchemy.preview.emergentagent.com/api/client/projects`
...
When you access: `https://text-alchemy.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://text-alchemy.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://text-alchemy.preview.emergentagent.com` (production)
