...
# CORS Configuration  
CORS_ORIGINS=https://content-studio-130.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://content-studio-130.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://content-studio-130.preview.emergentagent.com/api/client/projects`
...
When you access: `https://content-studio-130.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://content-studio-130.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://content-studio-130.preview.emergentagent.com` (production)
