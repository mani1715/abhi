...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://magical-brahmagupta-1.preview.emergentagent.com/api"
...
// Returns: "https://magical-brahmagupta-1.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://magical-brahmagupta-1.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://magical-brahmagupta-1.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://magical-brahmagupta-1.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://magical-brahmagupta-1.preview.emergentagent.com/api
[API Request] GET https://magical-brahmagupta-1.preview.emergentagent.com/api/client/projects
```
