...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://source-deploy.preview.emergentagent.com/api"
...
// Returns: "https://source-deploy.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://source-deploy.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://source-deploy.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://source-deploy.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://source-deploy.preview.emergentagent.com/api
[API Request] GET https://source-deploy.preview.emergentagent.com/api/client/projects
```
...
- Go to: `https://source-deploy.preview.emergentagent.com/client/dashboard`
- Login if needed
