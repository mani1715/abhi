...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://forge-studio-6.preview.emergentagent.com/api"
...
// Returns: "https://forge-studio-6.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://forge-studio-6.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://forge-studio-6.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://forge-studio-6.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://forge-studio-6.preview.emergentagent.com/api
[API Request] GET https://forge-studio-6.preview.emergentagent.com/api/client/projects
```
...
- Go to: `https://forge-studio-6.preview.emergentagent.com/client/dashboard`
- Login if needed
