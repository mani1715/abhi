...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://digital-canvas-94.preview.emergentagent.com/api"
...
// Returns: "https://digital-canvas-94.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://digital-canvas-94.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://digital-canvas-94.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://digital-canvas-94.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://digital-canvas-94.preview.emergentagent.com/api
[API Request] GET https://digital-canvas-94.preview.emergentagent.com/api/client/projects
```
