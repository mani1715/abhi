...
1. **Frontend page loads** over HTTPS: `https://digital-canvas-94.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://digital-canvas-94.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://digital-canvas-94.preview.emergentagent.com/client/dashboard`
