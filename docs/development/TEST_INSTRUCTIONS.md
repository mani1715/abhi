...
1. Navigate to: `https://abhi-service-hub.preview.emergentagent.com/client/login`
...
3. **Check Network Tab** (F12 → Network tab)
   - All requests should be to `https://abhi-service-hub.preview.emergentagent.com/api/...`
   - ❌ No requests should use `http://` protocol

#### C. Verify Data Syncing
1. Keep client dashboard open
2. In another tab, open admin panel: `https://abhi-service-hub.preview.emergentagent.com/admin/login`
...
#### A. Login
1. Navigate to: `https://abhi-service-hub.preview.emergentagent.com/admin/login`
2. Login with:
   - Username: `admin`
   - Password: `admin123`
...
#### A. Home Page
1. Navigate to: `https://abhi-service-hub.preview.emergentagent.com/`
...
```
[API Config] Base URL constructed: https://abhi-service-hub.preview.emergentagent.com/api
[API Request] GET /client/projects Base: https://abhi-service-hub.preview.emergentagent.com/api
[API Request] POST /admin/clients Base: https://abhi-service-hub.preview.emergentagent.com/api
```
...
### Client Login
- URL: `https://abhi-service-hub.preview.emergentagent.com/client/login`
