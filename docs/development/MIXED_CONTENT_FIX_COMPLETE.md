...
- Frontend was loaded over **HTTPS** (https://project-abhi.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://project-abhi.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://project-abhi.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://project-abhi.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://project-abhi.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://project-abhi.preview.emergentagent.com
- Admin Panel: https://project-abhi.preview.emergentagent.com/admin/login
