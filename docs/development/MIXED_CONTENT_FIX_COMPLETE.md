...
- Frontend was loaded over **HTTPS** (https://source-deploy.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://source-deploy.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://source-deploy.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://source-deploy.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://source-deploy.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://source-deploy.preview.emergentagent.com
- Admin Panel: https://source-deploy.preview.emergentagent.com/admin/login
