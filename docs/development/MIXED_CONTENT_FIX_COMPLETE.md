...
- Frontend was loaded over **HTTPS** (https://forge-studio-6.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://forge-studio-6.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://forge-studio-6.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://forge-studio-6.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://forge-studio-6.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://forge-studio-6.preview.emergentagent.com
- Admin Panel: https://forge-studio-6.preview.emergentagent.com/admin/login
