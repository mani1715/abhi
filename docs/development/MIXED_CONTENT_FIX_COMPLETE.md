...
- Frontend was loaded over **HTTPS** (https://text-alchemy.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://text-alchemy.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://text-alchemy.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://text-alchemy.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://text-alchemy.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://text-alchemy.preview.emergentagent.com
- Admin Panel: https://text-alchemy.preview.emergentagent.com/admin/login
