...
- Frontend was loaded over **HTTPS** (https://side-service.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://side-service.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://side-service.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://side-service.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://side-service.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://side-service.preview.emergentagent.com
- Admin Panel: https://side-service.preview.emergentagent.com/admin/login
