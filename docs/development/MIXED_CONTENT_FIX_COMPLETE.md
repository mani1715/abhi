...
- Frontend was loaded over **HTTPS** (https://abhi-service-hub.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://abhi-service-hub.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://abhi-service-hub.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://abhi-service-hub.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://abhi-service-hub.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://abhi-service-hub.preview.emergentagent.com
- Admin Panel: https://abhi-service-hub.preview.emergentagent.com/admin/login
