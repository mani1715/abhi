...
- Frontend was loaded over **HTTPS** (https://portfolioabhi.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://portfolioabhi.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://portfolioabhi.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://portfolioabhi.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://portfolioabhi.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://portfolioabhi.preview.emergentagent.com
- Admin Panel: https://portfolioabhi.preview.emergentagent.com/admin/login
