...
```
Page: https://side-service.preview.emergentagent.com/client/dashboard
API Call: /client/projects
Result: https://side-service.preview.emergentagent.com/api/client/projects
...
- [ ] Navigate to: `https://side-service.preview.emergentagent.com/client/dashboard`
...
**Next Step**: Please test in your browser at `https://side-service.preview.emergentagent.com` and verify:
