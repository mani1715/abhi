...
```
Mixed Content: The page at 'https://code-repo-1.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://code-repo-1.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://code-repo-1.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://code-repo-1.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://code-repo-1.preview.emergentagent.com/api/client/projects \
