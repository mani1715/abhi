...
- **Production HTTPS** (`https://code-rescue-56.preview.emergentagent.com`): Uses `/api` → converted to `https://code-rescue-56.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://code-rescue-56.preview.emergentagent.com,https://code-rescue-56.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://code-rescue-56.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://code-rescue-56.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://code-rescue-56.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://code-rescue-56.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://code-rescue-56.preview.emergentagent.com`
