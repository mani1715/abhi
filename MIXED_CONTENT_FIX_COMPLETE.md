...
- Frontend was loaded over **HTTPS** (https://dev-troubleshoot-4.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://dev-troubleshoot-4.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://dev-troubleshoot-4.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://dev-troubleshoot-4.preview.emergentagent.com/api" ✅
...
### 1. Test Admin Login
1. Navigate to: `https://dev-troubleshoot-4.preview.emergentagent.com/admin/login`
2. Enter credentials:
   - Username: `admin`
   - Password: `admin123`
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://dev-troubleshoot-4.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://dev-troubleshoot-4.preview.emergentagent.com
- Admin Panel: https://dev-troubleshoot-4.preview.emergentagent.com/admin/login
